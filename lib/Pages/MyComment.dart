  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 1,
        title: Text('我的评论',style: TextStyle(color: Color.fromARGB(255, 69, 69, 92), fontSize: 18),),
      ),
      body: StreamBuilder(
        stream: Firestore.instance.collection('users').document(docId).collection('Comment')
          .snapshots(),
          ...
          if(!snapshot.hasData){
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index){
                ...
                DocumentReference reference = refSnap['refcomment'];
                ...
                return Dismissible(
                  ...
                  onDismissed: (direction) {
                    TopicManagement().deleteComment(reference);
                    Scaffold.of(context).showSnackBar(
                        new SnackBar(
                            content: new Text("评论已删除"),

                        ));
                  },
                  // Show a red background as the item is swiped away
                  background: new Container(color:Color.fromARGB(255, 240, 123, 135)),
